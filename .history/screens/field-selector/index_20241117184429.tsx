...
export const FieldSelector: React.FC<FieldSelectorProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start flex-wrap gap-3 min-h-[70vh] overflow-y-auto">
      {fieldTypes.map((variant) => (
        <div className="flex flex-col items-center gap-1" key={variant.name}>
          <Button
            key={variant.name}
            variant="outline"
